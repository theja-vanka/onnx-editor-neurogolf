...
function persist(n, nodes, edges) {
    try {
...
function portToIndex(handle, _dir) {
    const m = handle.match(/-(\d+)$/);
    return m ? parseInt(m[1], 10) : 0;
}
function lookupTargetPort(handle, _target, _nodes) {
...
export function getOpSchemaCache() {
